...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Materials Type List</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
					<li class="breadcrumb-item active">Materials Type</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<a href="creatematerialstype.jsp"class="col-sm-2 btn btn-primary btn-block float-sm-right"> <i
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								String sql = "select * from materials_type";
								...
								<tr>
									...
									<td><%
										...
										<%} %></td>
									<td><a href="editmaterialstype.jsp?id=<%=rs.getInt(1)%>"><i
