			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="coutrylist.jsp">Materials Type
							List</a></li>
					<li class="breadcrumb-item active">Materials Type Create</li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">ENTER NEW MATERIALS TYPE DATA</h3>
					</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										placeholder="Enter Materials Type Name" name="name" required>
								</div>
							</div>
