			...
			<div class="col-md-12">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">ENTER NEW AREA DATA</h3>
					</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										placeholder="Enter Area Name" name="name" required>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										placeholder="Enter 6 digit PINCODE" name="pincode" required inputmode="numeric" pattern="[0-9]{6}" maxlength="6">
								</div>
							</div>
							<div class="form-group row">
