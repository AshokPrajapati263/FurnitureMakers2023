...
<title>Furniture Makers (Vendor)</title>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						...
						String userSql = "select * from user where id=9;";
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a href="<%=request.getContextPath()%>/VendorView/index.jsp"
							class="nav-link <%=(index == 1) ? "active" : ""%>"> <i
								class="nav-icon fas fa-tachometer-alt"></i>
								<p>Dashboard</p>
						</a></li>
						<li class="nav-item"><a href="<%=request.getContextPath()%>/VendorView/productlist.jsp"
							class="nav-link <%=(index == 2) ? "active" : ""%>"> <i
								class="nav-icon fas fa-box-open"></i>
								<p>Products</p>
						</a></li>
						<li class="nav-item"><a href="<%=request.getContextPath()%>/VendorView/subscriptiontypelist.jsp"
							class="nav-link <%=(index == 3) ? "active" : ""%>"> <i
								class="nav-icon fas fa-crown"></i>
								<p>Subscription</p>
						</a></li>
						<li class="nav-item"><a href="<%=request.getContextPath()%>/VendorView/promocodelist.jsp"
							class="nav-link <%=(index == 4) ? "active" : ""%>"> <i
								class="nav-icon fas fa-tags"></i>
								<p>PromoCode</p>
						</a></li>
						<li class="nav-item"><a href="<%=request.getContextPath()%>/VendorView/orderslist.jsp"
